                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="section__heading mb-0">
                            <h2 class="section__heading-title anim_top">Bloglar</h2>
                            <h5 class="section__heading-sup-title anim_top"><a href="index.php">Ana Sayfa</a> <span>/</span> <span class="current">Bloglar</span></h5>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="posts_box anim_top">
                            ...
                            <div class="posts_box-details">
                                ...
                                <h4 class="title"><a href="blog-detay.php">Fun Ways to Exercise With Your pet</a></h4>
                                <div class="desc">
